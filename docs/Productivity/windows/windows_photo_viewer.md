...
If you are used to Windows Photo Viewer for opening images, then you can bring that back in Windows 10.
...
``` title="Activate Windows Photo Viewer on Windows 10.reg"
